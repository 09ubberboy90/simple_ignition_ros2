...
def main(args=None):
    ...
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=-0.075, z=0.025)))
    block_spawner.spawn_model(Pose(position=Point(x=0.5, y=0.0, z=0.025))) # Main cube must be second
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=0.0, z=0.025)))
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=0.075, z=0.025)))
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=-0.0375, z=0.075)))
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=0.0375, z=0.075)))
    block_spawner.spawn_model(Pose(position=Point(x=1.5, y=0.0, z=0.125)))
